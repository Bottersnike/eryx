...
void eryx_register_embedded_modules(const EmbeddedNativeModule* native,
                                    const EmbeddedScriptModule* scripts) {
    s_embedded_native = native;
    s_embedded_scripts = scripts;
}

const EmbeddedNativeModule* eryx_get_embedded_native_modules() { return s_embedded_native; }

const EmbeddedScriptModule* eryx_get_embedded_script_modules() { return s_embedded_scripts; }
