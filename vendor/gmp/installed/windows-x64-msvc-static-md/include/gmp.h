...
__GMP_DECLSPEC void mp_set_memory_functions(void *(*)(size_t), void *(*)(void *, size_t, size_t),
                                            void (*)(void *, size_t)) __GMP_NOTHROW;

#define mp_get_memory_functions __gmp_get_memory_functions
__GMP_DECLSPEC void mp_get_memory_functions(void *(**)(size_t), void *(**)(void *, size_t, size_t),
                                            void (**)(void *, size_t)) __GMP_NOTHROW;
...
__GMP_DECLSPEC void gmp_randinit_lc_2exp(gmp_randstate_ptr, mpz_srcptr, unsigned long int,
                                         mp_bitcnt_t);
...
__GMP_DECLSPEC int mpz_congruent_2exp_p(mpz_srcptr, mpz_srcptr,
                                        mp_bitcnt_t) __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;

#define mpz_congruent_ui_p __gmpz_congruent_ui_p
__GMP_DECLSPEC int mpz_congruent_ui_p(mpz_srcptr, unsigned long,
...
__GMP_DECLSPEC int _mpq_cmp_ui(mpq_srcptr, unsigned long int,
...
__GMP_DECLSPEC mp_size_t mpn_gcdext(mp_ptr, mp_ptr, mp_size_t *, mp_ptr, mp_size_t, mp_ptr,
                                    mp_size_t);
...
__GMP_DECLSPEC mp_bitcnt_t mpn_hamdist(mp_srcptr, mp_srcptr,
...
__GMP_DECLSPEC mp_limb_t mpn_preinv_mod_1(mp_srcptr, mp_size_t, mp_limb_t,
...
__GMP_DECLSPEC void mpn_tdiv_qr(mp_ptr, mp_ptr, mp_size_t, mp_srcptr, mp_size_t, mp_srcptr,
                                mp_size_t);
...
__GMP_DECLSPEC void mpn_sec_powm(mp_ptr, mp_srcptr, mp_size_t, mp_srcptr, mp_bitcnt_t, mp_srcptr,
                                 mp_size_t, mp_ptr);
...
__GMP_DECLSPEC void mpn_sec_tabselect(volatile mp_limb_t *, volatile const mp_limb_t *, mp_size_t,
                                      mp_size_t, mp_size_t);
...
__GMP_EXTERN_INLINE void mpz_abs(mpz_ptr __gmp_w, mpz_srcptr __gmp_u) {
    if (__gmp_w != __gmp_u) mpz_set(__gmp_w, __gmp_u);
...
__GMP_EXTERN_INLINE
#endif
int mpz_fits_uint_p(mpz_srcptr __gmp_z) __GMP_NOTHROW { __GMPZ_FITS_UTYPE_P(__gmp_z, UINT_MAX); }
#endif
...
__GMP_EXTERN_INLINE
#endif
int mpz_fits_ulong_p(mpz_srcptr __gmp_z) __GMP_NOTHROW { __GMPZ_FITS_UTYPE_P(__gmp_z, ULONG_MAX); }
#endif
...
__GMP_EXTERN_INLINE
#endif
int mpz_fits_ushort_p(mpz_srcptr __gmp_z) __GMP_NOTHROW { __GMPZ_FITS_UTYPE_P(__gmp_z, USHRT_MAX); }
#endif
...
mp_bitcnt_t mpz_popcount(mpz_srcptr __gmp_u) __GMP_NOTHROW {
    ...
    if (__GMP_LIKELY(__gmp_usize > 0)) __gmp_result = mpn_popcount(__gmp_u->_mp_d, __gmp_usize);
    return __gmp_result;
}
#endif
...
__GMP_EXTERN_INLINE
#endif
size_t mpz_size(mpz_srcptr __gmp_z) __GMP_NOTHROW { return __GMP_ABS(__gmp_z->_mp_size); }
#endif
...
__GMP_EXTERN_INLINE void mpq_abs(mpq_ptr __gmp_w, mpq_srcptr __gmp_u) {
    if (__gmp_w != __gmp_u) mpq_set(__gmp_w, __gmp_u);
...
#define __GMPN_AORS(cout, wp, xp, xsize, yp, ysize, FUNCTION, TEST)    \
    do {                                                               \
        ...
        if ((wp) != (xp)) __GMPN_COPY_REST(wp, xp, xsize, __gmp_i);    \
        (cout) = 0;                                                    \
    __gmp_done:;                                                       \
    } while (0)
        ...
        if (CB(__gmp_r, __gmp_x, (v))) {                                        \
            ...
            for (__gmp_i = 1; __gmp_i < (n);) {                                 \
                ...
                if (!CB(__gmp_r, __gmp_x, 1)) {                                 \
                    if ((src) != (dst)) __GMPN_COPY_REST(dst, src, n, __gmp_i); \
                    (cout) = 0;                                                 \
                    break;                                                      \
                }                                                               \
            }                                                                   \
        } else {                                                                \
            if ((src) != (dst)) __GMPN_COPY_REST(dst, src, n, 1);               \
            (cout) = 0;                                                         \
        }                                                                       \
    } while (0)
#endif
...
#define __GMPN_COPY_REST(dst, src, size, start)                                               \
    do {                                                                                      \
        ...
        for (__gmp_j = (start); __gmp_j < (size); __gmp_j++) (dst)[__gmp_j] = (src)[__gmp_j]; \
    } while (0)
#endif
...
__GMP_EXTERN_INLINE
#endif
mp_limb_t mpn_add(mp_ptr __gmp_wp, mp_srcptr __gmp_xp, mp_size_t __gmp_xsize, mp_srcptr __gmp_yp,
...
__GMP_EXTERN_INLINE
#endif
mp_limb_t mpn_sub(mp_ptr __gmp_wp, mp_srcptr __gmp_xp, mp_size_t __gmp_xsize, mp_srcptr __gmp_yp,
                  mp_size_t __gmp_ysize) {
    mp_limb_t __gmp_c;
...
#define mpz_cmp_si(Z, SI)                                                                        \
    (__builtin_constant_p((SI) >= 0) && (SI) >= 0 ? mpz_cmp_ui(Z, __GMP_CAST(unsigned long, SI)) \
                                                  : _mpz_cmp_si(Z, SI))
...
#define mpq_cmp_si(q, n, d)                                                                      \
    (__builtin_constant_p((n) >= 0) && (n) >= 0 ? mpq_cmp_ui(q, __GMP_CAST(unsigned long, n), d) \
                                                : _mpq_cmp_si(q, n, d))
#else
...
#define __GNU_MP_RELEASE \
    (__GNU_MP_VERSION * 10000 + __GNU_MP_VERSION_MINOR * 100 + __GNU_MP_VERSION_PATCHLEVEL)
